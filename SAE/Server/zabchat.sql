...
CREATE USER 'zabchat'@'%' IDENTIFIED BY 'sdfghjkl';GRANT USAGE ON *.* TO 'zabchat'@'%';ALTER USER 'zabchat'@'%' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
